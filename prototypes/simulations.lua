...
simulations.endpoints = {
  init = [[
    ...
    game.surfaces[1].create_entities_from_blueprint_string({
      string = "..5QV2tjyplNq+0k0H63S2YDzwsWWwTVarEgSNx5GjhZ0Gcg3NJxrn5Y263DRlUXkDbQ517ajrNinBdvnrMizef4DWc0xtg==",
      position = { 0, -4 },
    })
