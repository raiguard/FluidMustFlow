...
data:extend({
  {
    ...
    fluid_box = {
      ...
      pipe_connections = {
        ...
        { direction = defines.direction.south, connection_category_bitmask = 2, position = { 0, 0.25 } },
      },
  ...
  },
  {
    ...
    fluid_box = {
      ...
      pipe_connections = {
        ...
        { direction = defines.direction.south, connection_category_bitmask = 2, position = { 0, 0.5 } },
      },
      hide_connection_info = true,
    },
    window_bounding_box = { { 0, 0 }, { 0, 0 } },
  ...
  },
  {
    ...
    fluid_box = {
      ...
      pipe_connections = {
        { direction = defines.direction.north, connection_category_bitmask = 2, position = { 0, -0.5 } },
        { direction = defines.direction.east, connection_category_bitmask = 2, position = { 0.5, 0 } },
        { direction = defines.direction.west, connection_category_bitmask = 2, position = { -0.5, 0 } },
      },
      hide_connection_info = true,
    },
    window_bounding_box = { { 0, 0 }, { 0, 0 } },
